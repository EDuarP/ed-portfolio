const translations = {
  en: {
    ...
    'projects.morpheus.text': 'Distributed edge-ML detection and localization system. Real-time signal classification on resource-constrained devices (Raspberry Pi 5), with model inference, geospatial triangulation, a FastAPI backend, a React dashboard, and an MQTT distributed architecture.',
  ...
  es: {
    ...
    'projects.morpheus.text': 'Sistema distribuido de detección y localización con edge-ML. Clasificación de señales en tiempo real sobre dispositivos de recursos limitados (Raspberry Pi 5), con inferencia de modelos, triangulación geoespacial, backend en FastAPI, dashboard en React y una arquitectura distribuida con MQTT.',
